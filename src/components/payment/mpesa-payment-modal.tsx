      ...
      if (type === 'enrolment') {
        ...
        if (existing) {
          if (existing.status === 'PENDING_PAYMENT') {
            throw new Error(
              'Your payment request is still pending. Please complete the M-Pesa prompt on your phone or wait for the current request to finish.',
            );
          }
          ...
          throw new Error(
            'You are already enrolled in this course. Please check your enrolled courses or explore other available courses.',
          );
        }
      }
