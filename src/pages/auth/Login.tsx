...
export default function AuthPage() {
  ...
  // Set initial panel from search params if present
  // Note: searchParams is extracted further down in the file
  useEffect(() => {
  ...
  usePageTitle(
    panel === 'login' ? 'Login | Access Your Vuka Afrique Account' : 'Join Vuka Afrique | Sign Up Today',
    panel === 'login'
      ? 'Sign in to your Vuka Afrique account to manage your courses, milestones, and payments securely.'
